...
export const MessagesSquareIcon = ({ className }: { className?: string }) => (
...
export const AppleIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M16.11,13.23a4.33,4.33,0,0,1,1.52-3.32,4.61,4.61,0,0,0-3.48-2,4.84,4.84,0,0,0-4.22,2.45,4.72,4.72,0,0,0-4.3-2.45c-2.8,0-5,2.3-5,5.55A5.1,5.1,0,0,0,5,21.68a5.9,5.9,0,0,0,4.8-2.58,5.43,5.43,0,0,0,4.61,2.58,5.32,5.32,0,0,0,5.18-5.35c0-1.14-.33-2.29-1-3.1ZM12.3,3.3A2.58,2.58,0,0,1,14.24,2a2.4,2.4,0,0,1,1.94.88,2.46,2.46,0,0,0-1.94,3,2.59,2.59,0,0,0-2.31-2.49A2.11,2.11,0,0,1,12.3,3.3Z"/>
    </svg>
);
