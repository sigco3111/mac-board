  ...
  const menuItems = [
    { 
      ...
      items: [
        ...
        { label: '데브 뉴스 아카이브', action: () => window.open('https://www.notion.so/AI-24976f2e9097809caecdebede4ee8e2c', '_blank', 'noopener,noreferrer'), disabled: false },
        { label: '데브 캔버스', action: () => window.open('https://dev-canvas-pi.vercel.app/', '_blank', 'noopener,noreferrer'), disabled: false },        
